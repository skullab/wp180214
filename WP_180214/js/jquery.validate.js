...
$.extend($.validator, {
	...
	messages: {
		...
		regex: $.validator.format("Si prega di inserire un valore valido : {0}"),
		remote: "Si prega di corregere questo campo.",
		...
		digits: "Si prega di inserire solo numeri.",
		...
		maxlength: $.validator.format("Si prega di non inserire pi&ugrave; di {0} caratteri."),
		minlength: $.validator.format("Si prega di inserire almeno {0} caratteri."),
		rangelength: $.validator.format("Si prega di inserire un valore compreso tra {0} e {1} caratteri al massimo."),
		range: $.validator.format("Si prega di inserire un valore compreso tra {0} e {1}."),
		max: $.validator.format("Si prega di inserire un valore minore o uguale a {0}."),
