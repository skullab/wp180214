	...
	if(get_option(SWP180214_OPT_GLOBAL_ERROR)){
		switch (get_option(SWP180214_OPT_GLOBAL_ERROR)){
			...
			case SWP180214_ERROR_MKDIR:
				...
				return;
				break;
			case SWP180214_ERROR_FEED_VERSION:
				function swp180214_warning_feed_version(){
					global $hook_suffix, $current_user;
					if ( $hook_suffix == 'plugins.php' ) {
						echo '<div class="updated" style="padding: 0; margin: 0; border: none; background: none;">
							<style type="text/css">
							...
							<div class="swp180214_description">
							<strong>'.SWP180214_DISPLAY_NAME.'</strong> -
							ERRORE '.get_option(SWP180214_OPT_GLOBAL_ERROR).' : La versione del FEED &egrave; diversa dalla versione dello schema in uso.Verificare le impostazioni.
							</div>
							</div>
							</div>  ' ;
					}
				}
				add_action('admin_notices', 'swp180214_warning_feed_version');
				return;
				break;
			case SWP180214_ERROR_FEED_USER:
				function swp180214_warning_feed_user(){
					global $hook_suffix, $current_user;
					if ( $hook_suffix == 'plugins.php' ) {
						echo '<div class="updated" style="padding: 0; margin: 0; border: none; background: none;">
							<style type="text/css">
							...
							<div class="swp180214_description">
							<strong>'.SWP180214_DISPLAY_NAME.'</strong> -
							ERRORE '.get_option(SWP180214_OPT_GLOBAL_ERROR).' : Il codice utente del FEED &egrave; diverso da quello in uso.Verificare le impostazioni.
							</div>
							</div>
							</div>  ' ;
					}
				}
				add_action('admin_notices', 'swp180214_warning_feed_user');
				return;
				break;
		}
	}
